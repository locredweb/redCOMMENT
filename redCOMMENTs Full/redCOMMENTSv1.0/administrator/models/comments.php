...
class RedcommentsModelcomments extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$this->setState('filter.discussion_id', $app->getUserStateFromRequest($this->context.'.filter.discussion_id', 'filter_discussion_id', '', 'string'));
		...
		parent::populateState('a.commenttext', 'asc');
	}
